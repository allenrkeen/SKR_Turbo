...
#define STRING_CONFIG_H_AUTHOR "(allenrkeen, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Beta"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 84 }
